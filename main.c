...
//     const void **user;
// 
// //     char pam_user[32], pam_service[32], pam_authtok[32], pam_tty[32], pam_user_prompt[32];
// 
// //     pam_user = pam_get_item(pam_handle, PAM_USER, user);
// //     pam_service = pam_get_item(pam_handle, PAM_SERVICE, user);
// //     pam_authtok = pam_get_item(pam_handle, PAM_AUTHTOK, user);
// //     pam_tty = pam_get_item(pam_handle, PAM_TTY, user);
// //     pam_user_prompt = pam_get_item(pam_handle, PAM_USER_PROMPT, user);
// 
// 
// //     mvprintw(LINES-6, 1, "%s", pam_get_item(pam_handle, PAM_USER, user));
// //     mvprintw(LINES-5, 1, "%s", pam_service);
// //     mvprintw(LINES-4, 1, "%s", pam_authtok);
// //     mvprintw(LINES-3, 1, "%s", pam_tty);
// //     mvprintw(LINES-3, 1, "%s", pam_tty);
// 
...
// 
// 
//         mvprintw(LINES-2, 1, "%s", username);
//         mvprintw(LINES-1, 1, "%s", userpw);
//         getch();
// 
